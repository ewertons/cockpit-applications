    ...
    return (
        <Modal variant={variant} isOpen onClose={onClose}>
            ...
            <ModalBody>
                        ...
                        {steps.map((s, i) => (
                            <li
                                ...
                                className={"ssh-wizard-step" +
                                    ...
                                    (i < index ? " done" : "")}
                            >
                                <span className="ssh-wizard-step-num">{i + 1}</span>
                                {" "}
                                <span className="ssh-wizard-step-name">{s.name}</span>
                            </li>
                        ))}
                    </ol>
                )}
                ...
                <div className="ssh-wizard-content">
                    {step.content}
                </div>
            </ModalBody>
            <ModalFooter>
